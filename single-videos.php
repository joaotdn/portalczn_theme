...
if ( get_field( 'portalczn_post_video' ) ):
	?>
    <div class="post-video container margin-bottom-1 position-relative">
        <div class="grid-container">
            <div class="grid-x grid-padding-x align-center">
                <div class="cell small-12 medium-7 position-relative padding-top-1 padding-bottom-1">
                    <div class="responsive-embed position-relative">
						<?php the_field( 'portalczn_post_video' ); ?>
                    </div>

                    <div class="video-options show-for-medium">
                        <a href="#" title="Acender/Apagar luz" data-video-light>
...
<?php endif; ?>
    ...
    <div class="video-options-mask"></div>
<?php get_footer(); ?>